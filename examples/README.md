...
3. The operations tree shows a pre-configured outside-profile op. Use
   `Operations > Generate G-code` — the bottom pane shows UCCNC G-code
   with arc leads and on-contour ramp descent.
